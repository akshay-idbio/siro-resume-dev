          ...
          <div className="main-ai-card status-card">
            ...
            <div className="progress-meta">
              ...
              <div className="token-grid timing-grid">
                ...
                <div>
                  <span>Started</span>
                  <strong>{activeJob?.started_at ? new Date(activeJob.started_at).toLocaleTimeString() : "-"}</strong>
                </div>
                <div>
                  <span>Completed</span>
                  <strong>{activeJob?.completed_at ? new Date(activeJob.completed_at).toLocaleTimeString() : "-"}</strong>
                </div>
              </div>
              ...
              <tbody>
                {jobs.map((job) => (
                  <tr key={job.job_id}>
                    ...
                    <td>{String(job.created_at || "").slice(0, 19).replace("T", " ")}</td>
                    <td>
