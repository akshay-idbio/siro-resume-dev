...
export default function HybridAnalyze() {
  ...
  return (
          ...
          { processed && (
            <section className="hybrid-cost-card">
              ...
              <div className="hybrid-cost-grid">
                <div>
                  <h4>{Number(status.token_usage?.input_tokens || 0).toLocaleString("en-IN", {
    ...
    hour12: true,
                ...
                <div>
                  <h4>{Number(status.token_usage?.output_tokens || 0).toLocaleString("en-IN", {
    timeZone: "Asia/Kolkata",
    day: "2-digit",
    month: "short",
    year: "numeric",
    ...
    hour12: true,
                ...
                <div>
                  <h4>{Number(status.token_usage?.total_tokens || 0).toLocaleString("en-IN", {
    timeZone: "Asia/Kolkata",
    day: "2-digit",
    month: "short",
    year: "numeric",
