...
async def process_db_backed_main_job_background(
    ...
    try:
        ...
        # Source of truth must be MongoDB job_resumes, not folder glob.
        # This preserves original filenames and prevents .PDF/.DOCX case issues.
        ...
        for resume_doc in resume_records:
            ...
            if file_path and os.path.exists(file_path):
                ...
                missing_resume_files.append(filename)
